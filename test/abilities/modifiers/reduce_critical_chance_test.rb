...
class ReduceCriticalChanceTest < ActiveSupport::TestCase
  ...
  test "Critical chance decrease should tick down each time it is used" do
    attacker = Dinosaur.new(damage: 500, health: 2000, speed: 130, critical_chance: 20, name: 'attacker', abilities: []).reset_attributes!
    defender = Dinosaur.new(damage: 500, health: 2000, speed: 130, critical_chance: 20, name: 'defender', abilities: []).reset_attributes!
