...
class DinosaursController < ApplicationController
  ...
  private
    ...
    def dinosaur_params
      params.require(:dinosaur).permit(:name, :level, :rarity, :health_26, :armor, :critical_chance, :speed, :damage_26, :dna, :left_id, :right_id, :speed_boosts, :health_boosts, :attack_boosts)
    end
