...
class TQStrategyTest < ActiveSupport::TestCase
  ...
  test "should return the only available ability without training" do
    d1 = Dinosaur.new(value: 1.0, health_26: 1000, damage_26: 100, speed: 130, level: 20, name: 'd1', abilities: [Strike], strategy: TQStrategy).reset_attributes!
    d2 = Dinosaur.new(value: -1.0, health_26: 1000, damage_26: 100, speed: 125, level: 20, name: 'd2', abilities: [Strike], strategy: RandomStrategy).reset_attributes!
  ...
  test "should return the any available ability without training" do
    d1 = Dinosaur.new(value: 1.0, health_26: 1000, damage_26: 100, speed: 130, level: 20, name: 'd1', abilities: [Strike, FierceStrike], strategy: TQStrategy).reset_attributes!
    d2 = Dinosaur.new(value: -1.0, health_26: 1000, damage_26: 100, speed: 125, level: 20, name: 'd2', abilities: [Strike], strategy: RandomStrategy).reset_attributes!
    result = TQStrategy.next_move(d1, d2)
