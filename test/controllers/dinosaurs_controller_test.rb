...
class DinosaursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinosaur" do
    assert_difference('Dinosaur.count') do
      post dinosaurs_url, params: { dinosaur: { damage: @dinosaur.damage, health: @dinosaur.health, left: @dinosaur.left, level: @dinosaur.level, name: @dinosaur.name, rarity: @dinosaur.rarity, right: @dinosaur.right, speed: @dinosaur.speed } }
    end
  ...
  test "should update dinosaur" do
    patch dinosaur_url(@dinosaur), params: { dinosaur: { damage: @dinosaur.damage, health: @dinosaur.health, left: @dinosaur.left, level: @dinosaur.level, name: @dinosaur.name, rarity: @dinosaur.rarity, right: @dinosaur.right, speed: @dinosaur.speed } }
